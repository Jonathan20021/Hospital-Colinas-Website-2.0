 ...
 *
 * La llamada al API interno se hace SERVER-SIDE (portal_api_call + portal_token) → el JWT nunca
 * llega al navegador y el endpoint queda scoped (es SU propia identidad; anti-IDOR por orden).
...
$res = $order
    ? portal_api_call('GET', "/portal/me/lab/$order", [], portal_token())
