...
<head>
    ...
    <meta property="og:image" content="<?= e(absolute_url(optimized_src($service['image'], 1280))) ?>">
    ...
    <meta name="twitter:image" content="<?= e(absolute_url(optimized_src($service['image'], 1280))) ?>">
    ...
    <link rel="stylesheet" href="<?= e(base_url('assets/css/app-contenido.css')) ?>?v=<?= e((string) (@filemtime(__DIR__ . '/assets/css/app-contenido.css') ?: 1)) ?>">
        ...
        <section class="service-hero">
            <div class="service-hero-shell">
                ...
                <figure class="service-hero-media">
                    <img<?= img_srcset_attrs($service['image'], '100vw') ?> alt="<?= e($service['title']) ?>" loading="eager">
                    <figcaption>
