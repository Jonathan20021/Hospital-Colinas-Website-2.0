        ...
        <div class="utility-bar">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div class="hidden items-center gap-7 md:flex">
                    <a href="<?= e(base_url('servicios/emergencia-adulto-y-pediatrica')) ?>" class="utility-link utility-emergency">
            ...
            <div class="main-nav-inner mx-auto flex h-[110px] max-w-7xl items-center px-4 sm:px-6 lg:px-8">
                ...
                <nav class="nav-primary" aria-label="Navegación principal">
                    ...
                    <div class="nav-dropdown" data-nav-dropdown>
                        <button type="button" class="<?= e($navClass('hospital')) ?> nav-dropdown-toggle" aria-haspopup="true" aria-expanded="false">
                            Hospital
                            <i data-lucide="chevron-down" class="h-3.5 w-3.5"></i>
                        </button>
                        <div class="nav-dropdown-menu" role="menu">
                            <a href="<?= e(base_url('nosotros')) ?>" role="menuitem"><i data-lucide="building-2" class="h-4 w-4"></i>Nosotros</a>
                            <a href="<?= e(base_url('liderazgo-institucional')) ?>" role="menuitem"><i data-lucide="users-round" class="h-4 w-4"></i>Liderazgo institucional</a>
                    ...
                    <a href="<?= e(base_url('directorio-medico')) ?>" class="<?= e($navClass('directorio')) ?>">Directorio médico</a>
                ...
                <nav class="mobile-menu-inner" aria-label="Navegación móvil">
                    ...
                    <details class="mobile-group">
                        ...
                        <div class="mobile-sub">
                            ...
                            <a href="<?= e(base_url('liderazgo-institucional')) ?>" class="mobile-sub-link">Liderazgo institucional</a>
                ...
                <div>
                    ...
                    <select id="specialty" name="specialty" required class="form-input">
                        ...
                        <?php foreach ($services['consultas']['items'] as $specialty): ?>
                            <option value="<?= e($specialty) ?>" <?= $defaultSpecialty === $specialty ? 'selected' : '' ?>><?= e($specialty) ?></option>
                        <?php endforeach; ?>
